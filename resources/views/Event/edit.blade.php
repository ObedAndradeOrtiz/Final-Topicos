                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="titulo"
                                                value="{{ $event->titulo }}" name="titulo" style="height: 3rem" required>
                                        </div>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" name="tipo" id="tipo" style="height: 3rem" required>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="descripcion" class="form-control" style="height: 3rem" id="exampleFormControlTextarea1"
                                                rows="3" required>{{ $event->descripcion }} </textarea>
                                        </div>
                                    </div>
