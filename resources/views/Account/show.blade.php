...
<main>
  ...
  <div class="container px-4 py-5" id="icon-grid">
    <h3 class="pb-2 border-bottom">¡Bienvenido! <strong>{{' '.$user->name.' '.$user->lastname}}</strong></h3>
     <p>Desde tu perfil podras administrar tus datos, revisar tue eTickes comprados</p>
     <h4>Perfil de Usuario</h4>
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
      <div class="col d-flex align-items-start">
        <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#tools"/></svg>
        <div>
          <a href="{{route('profile.edit',$user->id)}}" style="text-decoration: none;"><h4 class="fw-bold mb-0">Datos Personales</h4></a>
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
            <a href="{{route('profile.edit',$user->id)}}" style="text-decoration: none;"><h4 class="fw-bold mb-0">Cambiar clave</h4></a>
          <p>Paragraph of text beneath the heading to explain the heading.</p>
        </div>
      </div>
      <div class="col d-flex align-items-start">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-logout text-muted flex-shrink-0 me-3" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#597e8d" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
