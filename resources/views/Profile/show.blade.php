                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label class="form-control" id="Username"
                                            type="text">{{ $user->name }}</label>
                                    </div>
                                    <!-- Form Group (last name)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputLastName">Last name</label>
                                        <label class="form-control" id="Username"
                                            type="text">{{ $user->lastname }}</label>
                                    </div>
                                </div>
                                <!-- Form Row        -->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputOrgName" type="text"
                                            placeholder="Enter your organization name" value="UAGRM">
                                    </div>
                                    <!-- Form Group (location)-->
                                    <div class="col-md-6">
                                ...
                                <!-- Save changes button-->
                                <button class="btn"
                                    style=" background: #9053c7;
                        background: -webkit-linear-gradient(-135deg, #c850c0, #4158d0);
                        background: -o-linear-gradient(-135deg, #c850c0, #4158d0);
                        background: -moz-linear-gradient(-135deg, #c850c0, #4158d0);
                        background: linear-gradient(-135deg, #c850c0, #4158d0); 
                         type="button"><a
                                        style="color:#fff;" href="{{ route('profile.edit', $user->id) }}">Edit
                                        Profile</a></button>
                            </form>
                        </div>
                    </div>
