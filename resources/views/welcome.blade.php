...
<main>
 ...
 <h3  class="text-center" style="color:white; padding-top:20px;"><strong>Eventos Disponibles <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-calendar-event text-muted flex-shrink-0 me-3" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        <div class="col">
          <div class="card" style="width: 15rem; height: 30rem padding:2rem">
            ...
            <div class="card-body">
              ...
              -webkit-text-stroke: 0.5px black;"><strong>{{$event->titulo}}</strong> </h5>
             
              <a href="/register" class="btn btn-outline-warning btn-tickets" style="width:100%; ">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-ticket text-muted flex-shrink-0 me-3" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                  <line x1="15" y1="5" x2="15" y2="7" />
                  <line x1="15" y1="11" x2="15" y2="13" />
                  <line x1="15" y1="17" x2="15" y2="19" />
