        ...
        <div class="navbar navbar-dark bg-dark shadow-sm">
            <div class="container">
                <a href="/" class="navbar-brand d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-ticket js-tilt"
                        width="36" height="36" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff"
  ...
  <div class="container-login100">
   <div class="wrap-login100">
    <div class="login100-pic js-tilt" data-tilt>
     <img src="https://firebasestorage.googleapis.com/v0/b/fotagora-6e9a8.appspot.com/o/LOGIN.webp?alt=media&token=a1383183-8925-44d9-b447-624f094e1710" alt="IMG">
    </div>
      ...
      Iniciar Sesion
       @if (Session::has('warning'))
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                            <input class="input100" tylogin100-formpe="text" name="email" placeholder="Email">
