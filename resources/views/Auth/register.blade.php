		...
		<div class="container-login100">
          ...
          <div class="wrap-input100 validate-input"  data-validate = "Valid LastName is required" >
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="password" id="password" placeholder="Password" value="">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
                  ...
                  <div class="wrap-input100 validate-input" data-validate = "Password repeat is required">
						<input class="input100" type="password" name="passwrod2" id="password2" placeholder="Password repeat" value="">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>
